    ...
    <>
      <section className="relative overflow-hidden bg-black py-32 text-white">
        ...
        <div className="absolute inset-0 flex justify-center pointer-events-none">
          <div
            data-aos="fade-up"
            className="absolute h-[900px] w-[900px] rounded-full border border-white/10"
          ></div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="mx-auto max-w-5xl text-center" data-aos="fade-up">
            <h2 className="text-[clamp(3rem,6vw,6rem)] font-semibold xl:text-nowrap uppercase leading-[0.95]">
              DON'T TAKE MY WORD.
              <br />
              <span className="font-light italic lowercase text-zinc-400 itt">
                {" "}
                hear it directly
              FROM
              </span>
          ...
          <div className="mt-32 flex gap-12 overflow-x-auto px-6 ">
            {testimonials.map((item) => (
              ...
              >
                <p className="mb-8 text-yellow-400 tracking-[0.1em] select-none">
                  [★★★★★]
                </p>

                <p className="leading-8 text-balance text-zinc-300 max-sm:text-sm">
                  {item.review}
                </p>
